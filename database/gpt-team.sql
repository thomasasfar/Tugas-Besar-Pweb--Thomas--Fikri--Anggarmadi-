...
-- Dumping data for table gpt-team.forms: ~3 rows (approximately)
...
REPLACE INTO `users` (`user_id`, `username`, `email`, `password`, `active`, `avatar`, `created_at`, `updated_at`) VALUES
	(1, 'madd', 'madd@comp.co', '$2b$10$1jo.zs/Y8RKQ2RkYo/pmDeywG/bIXdL7m37E.l3Gu6ygdVrqrIdni', 1, NULL, '2023-06-12 14:07:25', '2023-06-12 14:07:25'),
	(2, 'admin', 'karir@adm.unand.ac.id', '$2b$10$310weJpT2uR2T08FMNNOnuovg1PGBLamD7IcDJXC1EfDVaOrgpZu6', 1, NULL, '2023-06-12 14:15:48', '2023-06-12 14:15:48');
